...
func (x *ReadResponse) GetLeaderId() string {
	if x != nil {
		return x.LeaderId
	}
	return ""
...
func (x *PeerStatus) GetNextIndex() uint64 {
	if x != nil {
		return x.NextIndex
	}
	return 0
...
type InspectLogResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Role          string                 `protobuf:"bytes,2,opt,name=role,proto3" json:"role,omitempty"`
	Term          uint64                 `protobuf:"varint,3,opt,name=term,proto3" json:"term,omitempty"`
	...
	SnapshotIndex uint64                 `protobuf:"varint,6,opt,name=snapshot_index,json=snapshotIndex,proto3" json:"snapshot_index,omitempty"`
...
func (x *InspectLogResponse) Reset() {
	*x = InspectLogResponse{}
	mi := &file_raft_v1_raft_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InspectLogResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InspectLogResponse) ProtoMessage() {}

func (x *InspectLogResponse) ProtoReflect() protoreflect.Message {
	mi := &file_raft_v1_raft_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InspectLogResponse.ProtoReflect.Descriptor instead.
func (*InspectLogResponse) Descriptor() ([]byte, []int) {
	return file_raft_v1_raft_proto_rawDescGZIP(), []int{16}
}

func (x *InspectLogResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *InspectLogResponse) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *InspectLogResponse) GetTerm() uint64 {
	if x != nil {
		return x.Term
	}
	return 0
...
func (x *InspectLogResponse) GetCommitIndex() uint64 {
	if x != nil {
		return x.CommitIndex
	}
	return 0
...
func (x *InspectLogResponse) GetLastApplied() uint64 {
	if x != nil {
		return x.LastApplied
	}
	return 0
...
func (x *InspectLogResponse) GetSnapshotIndex() uint64 {
	if x != nil {
		return x.SnapshotIndex
	}
	return 0
...
func (x *InspectLogResponse) GetEntries() []*LogEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *InspectLogResponse) GetState() map[string]string {
	if x != nil {
		return x.State
	}
	return nil
...
const file_raft_v1_raft_proto_rawDesc = "" +
	...
	"\x04term\x18\x01 \x01(\x04R\x04term\"6\n" +
	...
	"\x04term\x18\x03 \x01(\x04R\x04term\"\x1f\n" +
	...
	"matchIndex\x12\x1d\n" +
	"\n" +
	"next_index\x18\x04 \x01(\x04R\tnextIndex\"\xa3\x02\n" +
	...
	"\x05peers\x18\t \x03(\v2\x13.raft.v1.PeerStatusR\x05peers\"\x13\n" +
	"\x11InspectLogRequest\"\xde\x02\n" +
	"\x12InspectLogResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\x12\x12\n" +
	"\x04term\x18\x03 \x01(\x04R\x04term\x12!\n" +
	"\fcommit_index\x18\x04 \x01(\x04R\vcommitIndex\x12!\n" +
	"\flast_applied\x18\x05 \x01(\x04R\vlastApplied\x12%\n" +
	"\x0esnapshot_index\x18\x06 \x01(\x04R\rsnapshotIndex\x12+\n" +
	"\aentries\x18\a \x03(\v2\x11.raft.v1.LogEntryR\aentries\x12<\n" +
	"\x05state\x18\b \x03(\v2&.raft.v1.InspectLogResponse.StateEntryR\x05state\x1a8\n" +
	"\n" +
	"StateEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0fInstallSnapshot\x12\x1f.raft.v1.InstallSnapshotRequest\x1a .raft.v1.InstallSnapshotResponse2\xb8\x02\n" +
	"\rClientService\x126\n" +
	"\x05Write\x12\x15.raft.v1.WriteRequest\x1a\x16.raft.v1.WriteResponse\x128\n" +
	"\x06Delete\x12\x16.raft.v1.DeleteRequest\x1a\x16.raft.v1.WriteResponse\x123\n" +
	"\x04Read\x12\x14.raft.v1.ReadRequest\x1a\x15.raft.v1.ReadResponse\x129\n" +
	"\x06Status\x12\x16.raft.v1.StatusRequest\x1a\x17.raft.v1.StatusResponse\x12E\n" +
	"\n" +
	"InspectLog\x12\x1a.raft.v1.InspectLogRequest\x1a\x1b.raft.v1.InspectLogResponseB@Z>github.com/RishatShay/sna-final-project/internal/raftpb;raftpbb\x06proto3"
...
var file_raft_v1_raft_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_raft_v1_raft_proto_goTypes = []any{
	...
	(*DeleteRequest)(nil),           // 8: raft.v1.DeleteRequest
	(*WriteResponse)(nil),           // 9: raft.v1.WriteResponse
	(*ReadRequest)(nil),             // 10: raft.v1.ReadRequest
	(*ReadResponse)(nil),            // 11: raft.v1.ReadResponse
	(*StatusRequest)(nil),           // 12: raft.v1.StatusRequest
	(*PeerStatus)(nil),              // 13: raft.v1.PeerStatus
	(*StatusResponse)(nil),          // 14: raft.v1.StatusResponse
	(*InspectLogRequest)(nil),       // 15: raft.v1.InspectLogRequest
	(*InspectLogResponse)(nil),      // 16: raft.v1.InspectLogResponse
	nil,                             // 17: raft.v1.InspectLogResponse.StateEntry
}
var file_raft_v1_raft_proto_depIdxs = []int32{
	0,  // 0: raft.v1.AppendEntriesRequest.entries:type_name -> raft.v1.LogEntry
	13, // 1: raft.v1.StatusResponse.peers:type_name -> raft.v1.PeerStatus
	0,  // 2: raft.v1.InspectLogResponse.entries:type_name -> raft.v1.LogEntry
	17, // 3: raft.v1.InspectLogResponse.state:type_name -> raft.v1.InspectLogResponse.StateEntry
	1,  // 4: raft.v1.RaftService.RequestVote:input_type -> raft.v1.RequestVoteRequest
	3,  // 5: raft.v1.RaftService.AppendEntries:input_type -> raft.v1.AppendEntriesRequest
	5,  // 6: raft.v1.RaftService.InstallSnapshot:input_type -> raft.v1.InstallSnapshotRequest
	7,  // 7: raft.v1.ClientService.Write:input_type -> raft.v1.WriteRequest
	8,  // 8: raft.v1.ClientService.Delete:input_type -> raft.v1.DeleteRequest
	10, // 9: raft.v1.ClientService.Read:input_type -> raft.v1.ReadRequest
	12, // 10: raft.v1.ClientService.Status:input_type -> raft.v1.StatusRequest
	15, // 11: raft.v1.ClientService.InspectLog:input_type -> raft.v1.InspectLogRequest
	2,  // 12: raft.v1.RaftService.RequestVote:output_type -> raft.v1.RequestVoteResponse
	4,  // 13: raft.v1.RaftService.AppendEntries:output_type -> raft.v1.AppendEntriesResponse
	6,  // 14: raft.v1.RaftService.InstallSnapshot:output_type -> raft.v1.InstallSnapshotResponse
	9,  // 15: raft.v1.ClientService.Write:output_type -> raft.v1.WriteResponse
	9,  // 16: raft.v1.ClientService.Delete:output_type -> raft.v1.WriteResponse
	11, // 17: raft.v1.ClientService.Read:output_type -> raft.v1.ReadResponse
	14, // 18: raft.v1.ClientService.Status:output_type -> raft.v1.StatusResponse
	16, // 19: raft.v1.ClientService.InspectLog:output_type -> raft.v1.InspectLogResponse
